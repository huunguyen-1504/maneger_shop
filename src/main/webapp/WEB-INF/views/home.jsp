            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    <div class="categories__text">
                        ...
                        <a href="./Categories/Men’s">Shop now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="resources/img/categories/category-1.jpg">
                            <div class="categories__text">
                                <h4>Women’s fashion</h4>
                                <p>358 items</p>
                                <a href="./Categories/Women’s">Shop now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="resources/img/categories/category-3.jpg">
                            <div class="categories__text">
                                <h4>Kid’s fashion</h4>
                                <p>273 items</p>
                                <a href="./Categories/Kid’s">Shop now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="resources/img/categories/category-4.jpg">
                            <div class="categories__text">
                                <h4>Cosmetics</h4>
                                <p>159 items</p>
                                <a href="./Categories/Cosmetics">Shop now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="resources/img/categories/category-5.jpg">
                            <div class="categories__text">
                                <h4>Accessories</h4>
                                <p>792 items</p>
                                <a href="./Categories/Accessories">Shop now</a>
                            </div>
                        </div>
                    </div>
...
<section class="product spad">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                <ul class="filter__controls">
                    ...
                    <c:forEach var="sp1" items="${listDoiTuong}">
                    	<li data-filter=".${sp1.getTag()}">${sp1.getTenDoiTuong()}</li>
                    </c:forEach>                             
                </ul>
            </div>
        </div>
        ...
        <c:forEach var="sp" items="${listsp}">
            <div class="col-lg-3 col-md-4 col-sm-6 mix ${sp.getDoiTuong().getTag()}">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="resources/img/product/${sp.getHinhSP()}">
                        <div class="label statusPr" data-idsp="${sp.getIdSP()}"></div>
                    ...
                    <div class="product__item__text">
                        <h6><a href="./product-details/${sp.getIdSP()}">${sp.getTenSP()}</a></h6>
                        <div class="rating">
                        ...
                        <div class="product__price price">VNĐ ${sp.getGiaTien()}</div>
                    </div>
                </div>
            </div>
            </c:forEach>
