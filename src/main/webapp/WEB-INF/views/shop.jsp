                    ...
                    <div class="shop__sidebar">
                        <div class="sidebar__categories">
                            ...
                            <div class="categories__accordion">
                                ...
                                <!-- Start category listDoiTuong -->
                                <c:forEach var="getSP" items="${listDoiTuong}">
	                                    <div class="card">
	                                        <div class="card-heading active">
	                                            <a data-toggle="collapse" data-target="#collapse${getSP.getIdDoiTuong()}">${getSP.getTenDoiTuong()}</a>
	                                        </div>
	                                        <div id="collapse${getSP.getIdDoiTuong()}" class="collapse" data-parent="#accordionExample">
	                                            <div class="card-body">
	                                                <ul>
	                                                <c:forEach var="getLoai" items="${getSP.getLoaisps()}">
