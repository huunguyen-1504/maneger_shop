		...
		<div class="row content">
			<div class="col-sm-2 sidenav">
				...
				<div class="vertical-menu">
				  <a href="./admin" class="active menu"><i class="fa fa-home" aria-hidden="true"> </i> Home</a>
				  <a href="./admin/product" class="menu"><i class="fa fa-product-hunt" aria-hidden="true"> </i> Management Product</a>
