            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <span>${doiTuongByName.getTenDoiTuong()}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="accordion" id="accordionExample">                               
	                                    <div class="card">
	                                        <div class="card-heading active">
	                                            <a data-toggle="collapse" data-target="#collapse1">${doiTuongByName.getTenDoiTuong()}</a>
	                                        </div>
	                                        <div id="collapse1" class="collapse" data-parent="#accordionExample">
	                                            <div class="card-body">
	                                                <ul>
	                                               		<c:forEach var="getLoai" items="${doiTuongByName.getLoaisps()}">
	                                                    	<li><a href="#">${getLoai.getTenLoai()}</a></li>
	                                           			</c:forEach>
	                                                </ul>
	                                            </div>
	                                        </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row">                       
                        <!-- Start sp -->
                       <c:forEach var="listsp" items="${doiTuongByName.getSanPhams()}">
                        <div class="col-lg-4 col-md-6">      
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="resources/img/product/${listsp.getHinhSP()}">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="./product-details/${listsp.getIdSP()}">${listsp.getTenSP()}</a></h6>
                                    <div class="rating">
                                    ...
                                    <div class="product__price">VNĐ ${listsp.getGiaTien()}</div>
                                </div>
                            </div>
                        </div>
                        </c:forEach>
